...
#SBATCH --mem=70G
#SBATCH --output=./DifFracTion_validation_spikein_%x.out
#SBATCH --error=./DifFracTion_validation_spikein_%x.err
...
output_file="${output}/${chrom}_${pvalue}_${resolution}_${downsample}_${k_spike}_${normalization}/synthetic_validation.log"
...
python run_spikein_validation.py \
    --hic $hic \
    --k_spike $k_spike \
